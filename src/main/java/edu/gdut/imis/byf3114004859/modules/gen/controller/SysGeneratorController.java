package edu.gdut.imis.byf3114004859.modules.gen.controller;
...
import edu.gdut.imis.byf3114004859.common.xss.XssHttpServletRequestWrapper;
...
public class SysGeneratorController {
	...
	public void code(String prefix, String moduleName, String packageName, HttpServletRequest request, HttpServletResponse response) throws IOException{
		//获取表名，不进行xss过滤
		HttpServletRequest orgRequest = XssHttpServletRequestWrapper.getOrgRequest(request);
		String tables = orgRequest.getParameter("tables");

		String[] tableNames = new Gson().fromJson(tables, String[].class);
		byte[] data = sysGeneratorService.generatorCode(tableNames,prefix,moduleName,packageName);
